package com.ThinkIT.app.configuration.aop;

import java.util.Arrays;
import java.util.List;
import java.util.stream.Collectors;

import com.ThinkIT.app.dto.TraceDTO;
...
public class TraceAop {
	...
	@AfterReturning(pointcut = "execution(* com.ThinkIT.app.controller.*.*(..))", returning = "result")
	@Async
